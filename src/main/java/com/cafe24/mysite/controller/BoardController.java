...
public class BoardController {
	...
	public String delete(UserVo authUser, @PathVariable("no") Long boardNo,
...
//	@Auth
	...
	public String modify(UserVo authUser, @PathVariable("no") Long no, Model model) {
...
//	@Auth
	...
	public String modify(UserVo authUser, @ModelAttribute BoardVo boardVo,
			@RequestParam(value = "p", required = true, defaultValue = "1") Integer page,
			@RequestParam(value = "kwd", required = true, defaultValue = "") String keyword) {
...
//	@Auth
	...
	public String write(UserVo authUser, @ModelAttribute BoardVo boardVo,
			@RequestParam(value = "p", required = true, defaultValue = "1") Integer page,
			@RequestParam(value = "kwd", required = true, defaultValue = "") String keyword) {
